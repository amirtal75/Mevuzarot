...
public class OutputThreadTest implements Runnable {
    ...
    public OutputThreadTest(String myQueueUrl2, ConcurrentHashMap<Integer, InputFileObject> inputFileObjectById, String QueueUrlLocalApps, String summeryFilesIndicatorQueue) throws Exception {
